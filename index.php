...
<body style="overflow:hidden;">
    ...
    <nav class="blue darken-3" id="1565c0">
        ...
        <center style="font-size:25px;" class="hide-on-med-and-up">ARMS</center>
    </nav>
    <div class="row">
        <div class="col s12">
            <div class="col l8 m12 s12 hide-on-med-and-down">
                <img src="assets/images/pexels-fauxels-3183183.jpg" alt="login_background" class="responsive-img" style="min-height:100vh;object-fit:cover;">
            </div>
            ...
            <div class="col l4 m12 s12">
                ...
                <form action="" method="post">
                    ...
                    <!-- BUTTON -->
                    <div class="input-field col s12">
                        <input type="submit" value="login" name="login_session" class="btn-large col s12  blue">
                    </div>
